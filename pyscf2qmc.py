import sys
import numpy as np
#sys.path.append("/home/lkwagner/programs/")
from pyscf import gto
#mol=gto.Mole()
#mol.build(atom='O: 0 0 0',basis='bfd_vtz',ecp='bfd')
#mol.charge=0
#mol.spin=2
#mol.verbose=5
...
#print_slater(mol, m, 'qwalk.orb','qwalk.basis', open('qwalk.slater', 'w')) 
#print_sys(mol, open("qwalk.sys", 'w'))
#print_orb(mol,m,open("qwalk.orb",'w'))
#print_basis(mol, open("qwalk.basis", 'w'))
